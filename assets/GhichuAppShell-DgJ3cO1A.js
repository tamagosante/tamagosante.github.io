...
`)?e.split(`
`).map((e,t,n)=>(0,$.jsxs)(`span`,{children:[e,t<n.length-1&&(0,$.jsx)(`br`,{})]},t)):e}function Ln(e,t,n){let[r,i]=(0,U.useState)(null),a=(0,U.useRef)(null),o=(0,U.useCallback)((e,t=!0)=>{a.current&&clearTimeout(a.current),i(e),t&&(a.current=setTimeout(()=>i(null),kn))},[]),s=(0,U.useCallback)(()=>{a.current&&clearTimeout(a.current),i(null)},[]);return(0,U.useEffect)(()=>()=>{a.current&&clearTimeout(a.current)},[]),{placeholder:(0,U.useMemo)(()=>r||(e&&t&&n.trim()===``?On:null),[r,e,t,n]),showPlaceholder:o,clearPlaceholder:s}}var Rn=24,zn=(0,U.forwardRef)(function({line:e,isTopic:t,isCollapsed:n,isHighlighted:r,isEditing:i,depth:a,showTimestamps:o,showCardBorders:s,fontStyle:c,markdownPreview:l,timestampFormat:d,ghichuMode:f,editSubMode:p,lineActionsMode:m,onEdit:g,onDelete:_,onMoveUp:v,onMoveDown:y,onCreateTopic:x,onRemoveTopic:S,onFocusTopic:C,onToggleHighlight:w,onToggleCollapse:T,isPinned:ee,onTogglePin:te,highlights:E,onToggleTextHighlight:ne,onToggleHighlightMode:re,highlightColor:ie,onSetHighlightColor:D,onClearHighlights:O,onExtractHighlights:k,ancestorTopicIds:ae,onCollapseAncestor:A,hoveredStripTopicId:j,onHoverStrip:M,onInsertAbove:oe,onInsertBelow:N,onStartEditing:P,onStopEditing:F,autoFocus:I,isFirst:se},ce){let L=(0,U.useRef)(null);(0,U.useImperativeHandle)(ce,()=>L.current,[]);let le=f===`edit`,R=p===`highlight`,z=le&&i&&!R,ue=e.text.includes(`
`)||e.text.length>120,de=t||ue,B=m===`hide`?`opacity-0`:m===`disable`?`opacity-0 pointer-events-none`:``,[pe,me]=(0,U.useState)(!1),[he,ge]=(0,U.useState)(e.text.trim()!==``),{placeholder:_e,showPlaceholder:ve,clearPlaceholder:ye}=Ln(z,pe,e.text),V=(0,U.useRef)(0),be=(0,U.useRef)(!1),xe=(0,U.useCallback)(e=>{be.current=e},[]),{swipeType:H,dragProgress:Se,handleTouchStart:Ce,handleTouchMove:Te,handleTouchEnd:Ee}=we(),De=(0,U.useCallback)(()=>{if(!R)return;let e=window.getSelection();if(!e||e.rangeCount===0||e.isCollapsed)return;let t=e.getRangeAt(0),n=L.current;if(!n||!n.contains(t.startContainer)||!n.contains(t.endContainer))return;let r=document.createRange();r.setStart(n,0),r.setEnd(t.startContainer,t.startOffset);let i=r.toString().length,a=i+t.toString().length;e.removeAllRanges(),a>i&&ne(i,a)},[R,ne]),Oe=(0,U.useRef)(null),W=(0,U.useCallback)(e=>{if(z||R||!r||be.current)return;let t=L.current;if(t){let n=document.caretRangeFromPoint?.(e.clientX,e.clientY);if(n){let e=document.createRange();e.setStart(t,0),e.setEnd(n.startContainer,n.startOffset),Oe.current=e.toString().length}}P()},[z,R,r,P]),G=(0,U.useRef)(!1),K=(0,U.useCallback)(()=>{z||R||be.current||r||(G.current=!0,w())},[z,R,r,w]),ke=(0,U.useCallback)(()=>{if(!(z||R||r)){if(G.current){G.current=!1;return}w()}},[z,R,r,w]),Ae=(0,U.useCallback)(n=>{z||e.text.trim()===``||(n.preventDefault(),t?S():x())},[z,t,e.text,x,S]);(0,U.useEffect)(()=>{z&&(I?requestAnimationFrame(()=>{let e=L.current;e&&(e.textContent?.trim()===``&&(e.textContent=``),Fn(e))}):i&&requestAnimationFrame(()=>{let e=L.current;if(!e)return;e.focus({preventScroll:!0});let t=Oe.current;if(t!==null){Oe.current=null;let n=document.createTreeWalker(e,NodeFilter.SHOW_TEXT),r=t,i;for(;i=n.nextNode();){if(r<=i.length){let e=window.getSelection();if(e){let t=document.createRange();t.setStart(i,r),t.collapse(!0),e.removeAllRanges(),e.addRange(t)}return}r-=i.length}}}))},[I,i,z,e.text]);let je=(0,U.useCallback)(()=>{me(!0)},[]),Me=(0,U.useCallback)(()=>{if(me(!1),!L.current)return;ye();let t=Pn(L.current);ge(t.trim()!==``),t!==e.text&&g(t),F()},[e.text,e.lineId,z,g,ye,F]),Ne=(0,U.useCallback)(()=>{L.current&&ge((L.current.textContent??``).trim()!==``)},[]),Pe=(0,U.useCallback)(t=>{if(t.key===`Escape`){t.preventDefault(),L.current?.blur();return}if(t.key===`Backspace`){if(!L.current)return;if(Pn(L.current).trim()===``||e.text.trim()===``){t.preventDefault();let e=Date.now();e-V.current<=300?(V.current=0,ye(),_()):(V.current=e,ve(Dn));return}ye()}else t.key!==`Shift`&&t.key!==`Control`&&t.key!==`Alt`&&t.key!==`Meta`&&(ye(),V.current=0)},[e.text,_,ve,ye]);return(0,$.jsxs)(`div`,{"data-test":`ghichu-editor-line-container`,"data-line-id":e.lineId,className:`relative ${se?``:`pt-3`}`,style:a>0?{paddingLeft:a*Rn}:void 0,children:[r&&!z&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`button`,{"data-test":`ghichu-editor-line-insert-above`,className:`absolute -top-2.5 left-1/2 -translate-x-1/2 z-20 h-5 w-5 flex items-center justify-center text-muted-foreground/60 hover:text-foreground active:text-foreground transition-colors ${B}`,onClick:e=>{e.stopPropagation(),oe()},title:`Insert line above`,children:(0,$.jsx)(b,{className:`h-3 w-3`})}),(0,$.jsx)(`button`,{"data-test":`ghichu-editor-line-insert-below`,className:`absolute -bottom-2.5 left-1/2 -translate-x-1/2 z-20 h-5 w-5 flex items-center justify-center text-muted-foreground/60 hover:text-foreground active:text-foreground transition-colors ${B}`,onClick:e=>{e.stopPropagation(),N()},title:`Insert line below`,children:(0,$.jsx)(b,{className:`h-3 w-3`})})]}),ae.map((e,t)=>{let n=j===e;return(0,$.jsx)(`button`,{"data-test":`ghichu-editor-line-collapse`,className:`absolute top-3 bottom-0 w-4 flex justify-center transition-colors ${n?`bg-muted/50`:``} ${B}`,style:{left:-(a-t)*Rn-16},onClick:()=>A(e),onMouseEnter:()=>M(e),onMouseLeave:()=>M(null),onTouchStart:()=>M(e),onTouchEnd:()=>M(null),children:(0,$.jsx)(`div`,{className:`h-full transition-all ${n?`w-0.5 bg-primary/40`:`w-px bg-border`}`})},e)}),de&&T?(0,$.jsx)(`button`,{"data-test":`ghichu-editor-line-collapse`,className:`absolute -left-4 -top-1 -bottom-1 w-4 flex items-start mt-4 justify-center text-muted-foreground/60 hover:text-foreground rounded-l transition-colors ${j===e.lineId?`bg-muted/50 text-foreground`:`hover:bg-muted/50`} ${B}`,onClick:T,onMouseEnter:()=>M(e.lineId),onMouseLeave:()=>M(null),onTouchStart:()=>M(e.lineId),onTouchEnd:()=>M(null),children:n?(0,$.jsx)(h,{className:`h-3 w-3`}):(0,$.jsx)(u,{className:`h-3 w-3`})}):null,(0,$.jsx)(Tn,{text:e.text,isTopic:t,isCollapsed:n,isPinned:ee,onDelete:_,onCreateTopic:x,onRemoveTopic:S,onFocusTopic:C,onToggleCollapse:T??(()=>{}),onTogglePin:te,onMoveUp:v,onMoveDown:y,isHighlightMode:R,onToggleHighlightMode:re,highlightColor:ie,onSetHighlightColor:D,onClearHighlights:E.length>0?O:void 0,onExtractHighlights:E.length>0?k:void 0,preventNativeSelect:!z,onMenuOpenChange:xe,lineActionsMode:m,children:(0,$.jsxs)(`div`,{className:`min-w-0`,children:[(0,$.jsxs)(`div`,{"data-test":`ghichu-editor-line`,className:`group relative ${$e[c]} text-sm min-h-[37px] transition-colors ${s?`rounded-md border bg-card px-3 py-2 shadow-sm`:`border border-transparent px-1 py-0.5`} ${R?`cursor-crosshair`:z?``:`cursor-pointer active:bg-muted/30`} ${H?.direction===`right`?H.mode===`rapid`?`!bg-orange-200 dark:!bg-orange-800/40 rounded`:`!bg-orange-100 dark:!bg-orange-900/30 rounded`:H?.direction===`left`?H.mode===`rapid`?`!bg-blue-200 dark:!bg-blue-800/40 rounded`:`!bg-blue-100 dark:!bg-blue-900/30 rounded`:``} ${t?`border-l-4 border-l-primary/60 pl-3`:``} ${r&&!z?s?`border-primary/30 bg-primary/10`:`bg-primary/10 rounded`:s?t?`border-y-border border-r-border`:`border-border`:``}`,style:Se===0?void 0:{backgroundColor:Se>0?`rgba(255, 165, 0, ${Math.abs(Se)*.35})`:`rgba(100, 149, 237, ${Math.abs(Se)*.35})`,borderRadius:4},onTouchStart:Ce,onTouchMove:Te,onTouchEnd:e=>{K(),Ee(e)},onMouseDown:W,onClick:ke,children:[(Se!==0||H)&&(0,$.jsx)(`span`,{"data-test":`ghichu-editor-line-swipe-badge`,className:`absolute top-1 right-8 z-20 rounded px-1.5 py-0.5 text-[10px] font-mono font-bold leading-none pointer-events-none select-none`,style:{color:Se>0||H?.direction===`right`?`rgb(180, 90, 0)`:`rgb(50, 90, 180)`,backgroundColor:Se>0||H?.direction===`right`?`rgba(255, 165, 0, 0.15)`:`rgba(100, 149, 237, 0.15)`},children:H?H.mode===`rapid`?`⚡`:`→`:Math.round(Math.abs(Se)*100)}),!z&&!R&&(0,$.jsx)(`div`,{"data-test":`ghichu-editor-line-topic-hint`,className:`absolute left-0 top-0 bottom-0 w-5 z-10 hover:shadow-[inset_4px_0_8px_-4px_rgba(0,0,0,0.15)] transition-shadow`,onDoubleClick:Ae}),l&&!z?(0,$.jsx)(`span`,{"data-test":`ghichu-editor-text`,ref:L,className:`block min-w-0 break-words prose prose-sm dark:prose-invert max-w-none ${n?`overflow-hidden max-h-[4.5em]`:``}`,dangerouslySetInnerHTML:{__html:fe(e.text)||e.text}}):(0,$.jsxs)(`div`,{"data-test":`ghichu-editor-text-wrapper`,className:`relative`,children:[(0,$.jsx)(`span`,{"data-test":`ghichu-editor-text`,ref:L,contentEditable:z,suppressContentEditableWarning:!0,onFocus:z?je:void 0,onBlur:z?Me:void 0,onInput:z?Ne:void 0,onKeyDown:z?Pe:void 0,onMouseUp:R?De:void 0,className:`block min-w-0 outline-none break-words ${z||R?`select-text`:``} ${R?`cursor-crosshair ghichu-hl-sel`:``} ${n?`overflow-hidden max-h-[4.5em]`:`whitespace-pre-wrap`}`,children:!z&&E.length>0?(0,$.jsx)(En,{text:e.text,highlights:E}):In(e.text)}),_e&&!he&&(0,$.jsx)(`span`,{"data-test":`ghichu-editor-placeholder`,className:`pointer-events-none absolute inset-0 text-muted-foreground/40 select-none`,children:_e})]})]}),o&&(0,$.jsx)(`span`,{"data-test":`ghichu-editor-timestamp`,className:`text-muted-foreground/60 text-[10px] select-none mt-0.5 ml-1 block`,children:Mn(e.lastModified,d)})]})})]})}),Bn=`Unnamed`,Vn=500;function Hn(e){let t=new Map,n=e.map(e=>{let t=!e.title||e.title.trim()===``||e.title===`Untitled`;return{note:e,label:t?Bn:e.title,isUnnamed:t}});for(let{label:e}of n)t.set(e,(t.get(e)??0)+1);let r=new Map;return n.map(({note:e,label:n})=>{if((t.get(n)??1)<=1)return{id:e.id,title:e.title,displayTitle:n};let i=(r.get(n)??0)+1;return r.set(n,i),{id:e.id,title:e.title,displayTitle:`${n} (${i})`}})}function Un({notes:e,activeNoteId:t,onSelectNote:n,onCloseNote:r,onCreateNote:i,onRenameNote:a}){let o=(0,U.useMemo)(()=>Hn(e),[e]);return o.length===0?null:(0,$.jsxs)(`div`,{"data-test":`ghichu-editor-tabbar`,className:`flex shrink-0 items-center gap-0 overflow-x-auto border-b bg-muted/30`,children:[o.map(e=>(0,$.jsx)(Wn,{tab:e,isActive:e.id===t,onSelect:()=>n(e.id),onClose:r?()=>r(e.id):void 0,onRename:a?t=>a(e.id,t):void 0},e.id)),i&&(0,$.jsx)(P,{"data-test":`ghichu-editor-tab-create`,variant:`ghost`,size:`icon`,className:`h-9 w-9 shrink-0 text-muted-foreground hover:text-foreground active:bg-muted/70`,onClick:i,title:`New note`,children:(0,$.jsx)(b,{className:`h-3.5 w-3.5`})})]})}function Wn({tab:e,isActive:t,onSelect:n,onClose:r,onRename:i}){let[a,o]=(0,U.useState)(!1),s=(0,U.useRef)(null),c=(0,U.useRef)(null),l=(0,U.useRef)(!1),u=(0,U.useCallback)(()=>{i&&(o(!0),requestAnimationFrame(()=>{s.current?.select()}))},[i]),d=(0,U.useCallback)(()=>{i&&(o(!0),requestAnimationFrame(()=>{s.current?.select()}))},[i]),f=(0,U.useCallback)(()=>{l.current=!1,c.current=setTimeout(()=>{l.current=!0,d()},Vn)},[d]),p=(0,U.useCallback)(()=>{c.current&&=(clearTimeout(c.current),null)},[]),m=(0,U.useCallback)(()=>{a||l.current||n()},[a,n]),h=(0,U.useCallback)(()=>{let t=s.current?.value.trim();t&&t!==e.title&&t!==e.displayTitle&&i?.(t),o(!1)},[e.title,e.displayTitle,i]),g=(0,U.useCallback)(e=>{e.key===`Enter`?(e.preventDefault(),h()):e.key===`Escape`&&(e.preventDefault(),o(!1))},[h]);return(0,$.jsxs)(`div`,{"data-test":`ghichu-editor-tab`,className:`group flex items-center gap-1 border-r px-3 py-1.5 text-xs cursor-pointer transition-colors ${t?`bg-background text-foreground border-b-2 border-b-primary`:`text-muted-foreground hover:text-foreground hover:bg-muted/50 active:bg-muted/70`}`,onClick:m,onDoubleClick:u,onTouchStart:f,onTouchEnd:p,children:[a?(0,$.jsx)(`input`,{"data-test":`ghichu-editor-tab-rename`,ref:s,defaultValue:e.title,onBlur:h,onKeyDown:g,className:`w-24 bg-transparent outline-none border-b border-primary text-xs`,autoFocus:!0}):(0,$.jsx)(`span`,{"data-test":`ghichu-editor-tab-title`,className:`truncate max-w-32`,children:e.displayTitle}),r&&!a&&(0,$.jsx)(P,{"data-test":`ghichu-editor-tab-close`,variant:`ghost`,size:`icon`,className:`h-4 w-4 shrink-0 transition-opacity ${t?`opacity-100`:`group-hover:opacity-100 md:opacity-0`}`,onClick:e=>{e.stopPropagation(),r()},children:(0,$.jsx)(C,{className:`h-3 w-3`})})]})}var Gn=(0,U.forwardRef)(function(e,t){return(0,$.jsx)(Te,{ref:t,placeholder:`Type a message...`,...e})});function Kn(e){return new Date(e).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`,second:`2-digit`})}function qn(e){switch(e.type){case`insert`:return`INSERT L${e.line}`;case`delete`:return`DELETE L${e.line}`;case`update`:return`UPDATE L${e.line}`;case`undo`:return`UNDO ${e.targetOp.type.toUpperCase()}`;case`redo`:return`REDO ${e.targetOp.type.toUpperCase()}`;case`topic-created`:return`TOPIC+`;case`topic-removed`:return`TOPIC-`}}function Jn(e){switch(e){case`insert`:return`text-green-600 dark:text-green-400`;case`delete`:return`text-red-600 dark:text-red-400`;case`update`:return`text-yellow-600 dark:text-yellow-400`;case`undo`:return`text-blue-600 dark:text-blue-400`;case`redo`:return`text-purple-600 dark:text-purple-400`;case`topic-created`:return`text-teal-600 dark:text-teal-400`;case`topic-removed`:return`text-orange-600 dark:text-orange-400`}}function Yn(e){switch(e.type){case`insert`:case`update`:return e.text;case`undo`:case`redo`:return`targetOp`in e&&`text`in e.targetOp?e.targetOp.text:null;case`delete`:return null;case`topic-created`:return e.title;case`topic-removed`:return null}}function Xn({operations:e}){return e.length===0?(0,$.jsx)(`p`,{"data-test":`ghichu-log-viewer-empty`,className:`p-4 text-sm text-muted-foreground`,children:`No operations yet.`}):(0,$.jsx)(`div`,{"data-test":`ghichu-log-viewer`,className:`h-full overflow-y-auto p-2`,children:(0,$.jsx)(`div`,{"data-test":`ghichu-log-viewer-list`,className:`space-y-0.5`,children:[...e].reverse().map((t,n)=>{let r=Yn(t);return(0,$.jsxs)(`div`,{"data-test":`ghichu-log-entry`,className:`flex items-start gap-2 rounded px-2 py-1 font-mono text-xs hover:bg-muted/50`,children:[(0,$.jsx)(`span`,{"data-test":`ghichu-log-entry-time`,className:`shrink-0 text-muted-foreground/60`,children:Kn(t.timestamp)}),(0,$.jsx)(`span`,{"data-test":`ghichu-log-entry-label`,className:`shrink-0 font-semibold ${Jn(t.type)}`,children:qn(t)}),r&&(0,$.jsx)(`span`,{"data-test":`ghichu-log-entry-text`,className:`min-w-0 truncate text-muted-foreground`,children:r})]},e.length-1-n)})})})}function Zn(){let[e,t]=(0,U.useState)(navigator.onLine),[n,r]=(0,U.useState)({registered:!1,state:`none`,scope:null,cachedAssets:0}),[i,a]=(0,U.useState)(null),o=(0,U.useCallback)(async()=>{let e=0;try{let t=await caches.keys();for(let n of t){let t=await(await caches.open(n)).keys();e+=t.length}}catch{}if(!(`serviceWorker`in navigator)){r({registered:!1,state:`none`,scope:null,cachedAssets:e});return}let t=await navigator.serviceWorker.getRegistrations();if(t.length>0){let n=t[0],i=`none`;n.installing?i=`installing`:n.waiting?i=`waiting`:n.active&&(i=`active`),r({registered:!0,state:i,scope:n.scope,cachedAssets:e})}else r({registered:!1,state:`none`,scope:null,cachedAssets:e})},[]);(0,U.useEffect)(()=>{let e=()=>t(!0),n=()=>t(!1);return window.addEventListener(`online`,e),window.addEventListener(`offline`,n),o(),()=>{window.removeEventListener(`online`,e),window.removeEventListener(`offline`,n)}},[o]);let s=(0,U.useCallback)(async()=>{if(!(`serviceWorker`in navigator))return;let e=await navigator.serviceWorker.getRegistrations();for(let t of e)await t.unregister();a(`Unregistered. Reload to take effect.`),await o()},[o]),c=(0,U.useCallback)(async()=>{let e=await caches.keys();await Promise.all(e.map(e=>caches.delete(e))),a(`Cleared ${e.length} cache(s)`),await o(),setTimeout(()=>a(null),3e3)},[o]),l=(0,U.useCallback)(async()=>{if(!(`serviceWorker`in navigator))return;let e=await navigator.serviceWorker.getRegistrations();for(let t of e)t.waiting&&t.waiting.postMessage({type:`SKIP_WAITING`});a(`Activating... reload page`),setTimeout(()=>{window.location.reload()},500)},[]),u=(0,U.useCallback)(async()=>{try{let e=await caches.open(Qe),t=0,n=new Set,r=await fetch(window.location.href,{cache:`reload`});await e.put(window.location.href,r),t++,n.add(window.location.href);let i=performance.getEntriesByType(`resource`).map(e=>e.name).filter(e=>e.startsWith(window.location.origin)&&!n.has(e)),s=[...Array.from(document.querySelectorAll(`script[src]`)).map(e=>e.src),...Array.from(document.querySelectorAll(`link[href]`)).map(e=>e.href)].filter(e=>e.startsWith(window.location.origin)&&!n.has(e)),c=[...new Set([...i,...s])];a(`Caching ${c.length+1} assets...`);for(let r of c)if(!n.has(r)){n.add(r);try{let n=await fetch(r,{cache:`reload`});n.ok&&(await e.put(r,n),t++)}catch{}}a(`Cached ${t} assets`),await o(),setTimeout(()=>a(null),5e3)}catch(e){a(`Cache failed: ${e}`)}},[o]);return(0,$.jsxs)(`div`,{"data-test":`ghichu-pwa-status`,className:`flex flex-col gap-3 border-t pt-4`,children:[(0,$.jsx)(`h3`,{className:`text-sm font-medium`,children:`PWA Status`}),(0,$.jsx)(`div`,{"data-test":`ghichu-pwa-network`,className:`flex items-center gap-2`,children:e?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(te,{className:`h-4 w-4 text-green-500`}),(0,$.jsx)(`span`,{className:`text-sm text-green-600`,children:`Online`})]}):(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(D,{className:`h-4 w-4 text-red-500`}),(0,$.jsx)(`span`,{className:`text-sm text-red-600`,children:`Offline`})]})}),(0,$.jsxs)(`div`,{"data-test":`ghichu-pwa-sw`,className:`flex flex-col gap-1`,children:[(0,$.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,$.jsx)(`span`,{className:`text-sm`,children:`Service Worker:`}),n.registered?(0,$.jsx)(`span`,{className:`text-sm ${n.state===`active`?`text-green-600`:`text-yellow-600`}`,children:n.state}):(0,$.jsx)(`span`,{className:`text-sm text-muted-foreground`,children:`not registered`}),n.state===`waiting`&&(0,$.jsx)(P,{"data-test":`ghichu-pwa-skip-waiting`,variant:`outline`,size:`sm`,className:`h-6 px-2 text-xs`,onClick:()=>void l(),children:`Activate`})]}),(0,$.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,$.jsx)(`span`,{className:`text-sm`,children:`Cached assets:`}),(0,$.jsx)(`span`,{className:`text-sm ${n.cachedAssets>0?`text-green-600`:`text-muted-foreground`}`,children:n.cachedAssets})]}),n.scope&&(0,$.jsxs)(`p`,{className:`text-xs text-muted-foreground truncate`,children:[`Scope: `,n.scope]})]}),(0,$.jsxs)(`div`,{className:`flex flex-col gap-2`,children:[(0,$.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,$.jsxs)(P,{"data-test":`ghichu-pwa-refresh`,variant:`outline`,size:`sm`,className:`flex-1 gap-1`,onClick:()=>void o(),children:[(0,$.jsx)(v,{className:`h-3 w-3`}),`Refresh`]}),(0,$.jsx)(P,{"data-test":`ghichu-pwa-force-cache`,variant:`outline`,size:`sm`,className:`flex-1`,onClick:()=>void u(),children:`Force cache`})]}),(0,$.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,$.jsx)(P,{"data-test":`ghichu-pwa-clear-cache`,variant:`outline`,size:`sm`,className:`flex-1`,onClick:()=>void c(),children:`Clear cache`}),n.registered&&(0,$.jsx)(P,{"data-test":`ghichu-pwa-unregister`,variant:`outline`,size:`sm`,className:`flex-1 text-destructive hover:text-destructive`,onClick:()=>void s(),children:`Unregister`})]})]}),i&&(0,$.jsx)(`p`,{"data-test":`ghichu-pwa-action-status`,className:`text-xs text-muted-foreground`,children:i}),(0,$.jsx)(`p`,{className:`text-xs text-muted-foreground`,children:n.cachedAssets>0?`App is cached for offline use.`:`Click Force cache to enable offline support.`})]})}var Qn=`ghichu-data.json`,$n=`Notes`,er=`Local Notes`;function tr(){let e=localStorage.getItem(K);if(!e||JSON.parse(e).length===0){let e=W.create($n);localStorage.setItem(K,JSON.stringify([e.toJSON()]))}let t=B.getState().state;t&&Object.keys(t.projects).length>0||B.getState().project.create(er)}function nr(e){return e.map(e=>{let t=`# ${e.title}`,n=(e.content?.trim()??``).replace(/<br\s*\/?>/gi,`
`);return n?`${t}\n\n${n}`:t}).join(`

---

`)}function rr(){return{version:1,exportedAt:new Date().toISOString(),notes:JSON.parse(localStorage.getItem(`ghichu_notes`)??`[]`),settings:JSON.parse(localStorage.getItem(`ghichu_settings`)??`{}`)}}function ir(e,t){if(t)localStorage.setItem(K,JSON.stringify(e.notes)),localStorage.setItem(ke,JSON.stringify(e.settings));else{let t=JSON.parse(localStorage.getItem(`ghichu_notes`)??`[]`),n=Array.isArray(e.notes)?e.notes:[],r=new Set(t.map(e=>e.id)),i=[...t,...n.filter(e=>!r.has(e.id))];localStorage.setItem(K,JSON.stringify(i))}}function ar({onReload:e}){let[t,n]=(0,U.useState)(()=>localStorage.getItem(ze)===`true`),[r,i]=(0,U.useState)(!1),[a,s]=(0,U.useState)(null),[c,l]=(0,U.useState)(!1),[u,d]=(0,U.useState)(null),f=(0,U.useRef)(null),p=(0,U.useCallback)(t=>{localStorage.setItem(ze,String(t)),n(t),t&&tr(),q.reset(),e()},[e]),m=(0,U.useCallback)(()=>{localStorage.removeItem(K),localStorage.removeItem(ke),tr(),l(!1),q.reset(),e()},[e]),h=(0,U.useCallback)(()=>{let e=rr(),t=new Blob([JSON.stringify(e,null,2)],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=Qn,r.click(),URL.revokeObjectURL(n)},[]),g=(0,U.useCallback)(async()=>{let e=nr(JSON.parse(localStorage.getItem(`ghichu_notes`)??`[]`));await navigator.clipboard.writeText(e),d(`Copied to clipboard`),setTimeout(()=>d(null),2e3)},[]),_=(0,U.useCallback)(()=>{f.current?.click()},[]),v=(0,U.useCallback)(async t=>{let n=t.target.files?.[0];if(n){try{let t=await n.text(),i=JSON.parse(t);if(i.version!==1||!i.notes){s(`Invalid file format`);return}ir(i,r),q.reset(),e(),s(`Imported ${Array.isArray(i.notes)?i.notes.length:0} notes`)}catch{s(`Failed to parse file`)}t.target.value=``}},[r,e]);return(0,$.jsxs)(`div`,{"data-test":`ghichu-data-panel`,className:`flex flex-col gap-6 p-4`,children:[(0,$.jsxs)(`div`,{"data-test":`ghichu-data-local-mode`,className:`flex flex-col gap-2`,children:[(0,$.jsxs)(`div`,{className:`flex items-center justify-between`,children:[(0,$.jsx)(F,{htmlFor:`local-mode-toggle`,className:`text-sm font-medium`,children:`Local storage mode`}),(0,$.jsx)(I,{"data-test":`ghichu-local-mode-toggle`,id:`local-mode-toggle`,checked:t,onCheckedChange:p})]}),(0,$.jsx)(`p`,{className:`text-xs text-muted-foreground`,children:t?`Data stored in browser only. No backend sync.`:`Data synced with backend API.`})]}),(0,$.jsxs)(`div`,{"data-test":`ghichu-data-export`,className:`flex flex-col gap-2`,children:[(0,$.jsxs)(P,{"data-test":`ghichu-export-button`,variant:`outline`,size:`sm`,className:`w-full justify-start gap-2`,onClick:h,children:[(0,$.jsx)(O,{className:`h-4 w-4`}),`Export data`]}),(0,$.jsx)(`p`,{className:`text-xs text-muted-foreground`,children:`Downloads notes and settings as JSON.`})]}),(0,$.jsxs)(`div`,{"data-test":`ghichu-data-copy-markdown`,className:`flex flex-col gap-2`,children:[(0,$.jsxs)(P,{"data-test":`ghichu-copy-markdown-button`,variant:`outline`,size:`sm`,className:`w-full justify-start gap-2`,onClick:()=>void g(),children:[(0,$.jsx)(ee,{className:`h-4 w-4`}),`Copy as markdown`]}),u&&(0,$.jsx)(`p`,{"data-test":`ghichu-copy-status`,className:`text-xs text-muted-foreground`,children:u}),(0,$.jsx)(`p`,{className:`text-xs text-muted-foreground`,children:`Copies all notes to clipboard in markdown format.`})]}),(0,$.jsxs)(`div`,{"data-test":`ghichu-data-import`,className:`flex flex-col gap-3`,children:[(0,$.jsxs)(`div`,{className:`flex items-center justify-between`,children:[(0,$.jsx)(F,{htmlFor:`overwrite-toggle`,className:`text-sm`,children:`Overwrite existing data`}),(0,$.jsx)(I,{"data-test":`ghichu-overwrite-toggle`,id:`overwrite-toggle`,checked:r,onCheckedChange:i})]}),(0,$.jsxs)(P,{"data-test":`ghichu-import-button`,variant:`outline`,size:`sm`,className:`w-full justify-start gap-2`,onClick:_,children:[(0,$.jsx)(j,{className:`h-4 w-4`}),`Import data`]}),(0,$.jsx)(`input`,{ref:f,type:`file`,accept:`.json`,className:`hidden`,onChange:e=>void v(e)}),a&&(0,$.jsx)(`p`,{"data-test":`ghichu-import-status`,className:`text-xs text-muted-foreground`,children:a})]}),(0,$.jsxs)(`div`,{"data-test":`ghichu-data-clear`,className:`flex flex-col gap-2 border-t pt-4`,children:[c?(0,$.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,$.jsx)(P,{"data-test":`ghichu-clear-confirm`,variant:`destructive`,size:`sm`,className:`flex-1`,onClick:m,children:`Confirm clear`}),(0,$.jsx)(P,{"data-test":`ghichu-clear-cancel`,variant:`outline`,size:`sm`,className:`flex-1`,onClick:()=>l(!1),children:`Cancel`})]}):(0,$.jsxs)(P,{"data-test":`ghichu-clear-button`,variant:`outline`,size:`sm`,className:`w-full justify-start gap-2 text-destructive hover:text-destructive`,onClick:()=>l(!0),children:[(0,$.jsx)(o,{className:`h-4 w-4`}),`Clear local data`]}),(0,$.jsx)(`p`,{className:`text-xs text-muted-foreground`,children:`Removes all notes and settings from browser storage.`})]}),(0,$.jsx)(Zn,{})]})}var or=xe(void 0,H()??`default-user`);function sr({onCanvasSelected:e}){let t=pe(e=>e.state?.projects??{}),n=pe(e=>e.state?.activeProjectId??null),r=pe(e=>(n?e.state?.projects[n]:null)?.activeWorkspaceId??null),i=pe(e=>{let t=n?e.state?.projects[n]:null;return(r?t?.workspaces[r]:null)?.activeCanvasId??null}),a=(0,U.useMemo)(()=>{let e=new Set;return n&&e.add(`project-${n}`),r&&e.add(`workspace-${r}`),e},[n,r]),o=(0,U.useMemo)(()=>Object.values(t).sort((e,t)=>(e.sortOrder??0)-(t.sortOrder??0)).map(e=>({id:`project-${e.id}`,label:e.name,data:{type:`project`,id:e.id},children:Object.values(e.workspaces).sort((e,t)=>(e.sortOrder??0)-(t.sortOrder??0)).map(t=>({id:`workspace-${t.id}`,label:t.name,data:{type:`workspace`,id:t.id,projectId:e.id},children:Object.values(t.canvases).sort((e,t)=>(e.sortOrder??0)-(t.sortOrder??0)).map(n=>({id:`canvas-${n.id}`,label:n.name,data:{type:`canvas`,id:n.id,workspaceId:t.id,projectId:e.id},children:[]}))}))})),[t]),s=(0,U.useCallback)(t=>{if(t.data?.type===`canvas`){let{id:n,workspaceId:r,projectId:i}=t.data,a=B.getState();a.project.switch(i),a.workspace.switch(r),a.projectCanvas.switch(n),e(n,r,i)}},[e]),c=(0,U.useCallback)(async(e,t)=>{let n=B.getState();if(e.startsWith(`project-`)){let r=e.replace(`project-`,``);await or.projects.update(r,t),n.project.updateMetadata(r,{name:t})}else if(e.startsWith(`workspace-`)){let r=e.replace(`workspace-`,``);await or.workspaces.update(r,t),n.workspace.updateMetadata(r,{name:t})}else if(e.startsWith(`canvas-`)){let r=e.replace(`canvas-`,``);await or.canvases.update(r,t),n.projectCanvas.updateMetadata(r,{name:t})}},[]),l=(0,U.useCallback)(async e=>{let t=B.getState();if(e.startsWith(`project-`)){let n=e.replace(`project-`,``);await or.projects.delete(n),t.project.delete(n)}else if(e.startsWith(`workspace-`)){let n=e.replace(`workspace-`,``);await or.workspaces.delete(n),t.workspace.delete(n)}else if(e.startsWith(`canvas-`)){let n=e.replace(`canvas-`,``);await or.canvases.delete(n),t.projectCanvas.delete(n)}},[]),u=(0,U.useCallback)(e=>{let t=[];if(e.data?.type===`project`&&t.push({id:`add-workspace`,label:`Add Workspace`,icon:(0,$.jsx)(m,{className:`h-3.5 w-3.5`}),onClick:async()=>{let t=e.data.id,n=await or.workspaces.create(t,`New Workspace`),r=B.getState();r.project.switch(t),r.workspace.create(n.name,null,n.id)}}),e.data?.type===`workspace`){let{id:n,projectId:r}=e.data;t.push({id:`add-canvas`,label:`Add Canvas`,icon:(0,$.jsx)(y,{className:`h-3.5 w-3.5`}),onClick:async()=>{let e=await or.canvases.create(n,`New Canvas`),t=B.getState();t.project.switch(r),t.workspace.switch(n),t.projectCanvas.create(e.name,e.id)}}),t.push({id:`add-sub-workspace`,label:`Add Workspace`,icon:(0,$.jsx)(m,{className:`h-3.5 w-3.5`}),onClick:async()=>{let e=await or.workspaces.create(r,`New Workspace`),t=B.getState();t.project.switch(r),t.workspace.create(e.name,null,e.id)}})}return t.length>0?t:null},[]);return o.length===0?(0,$.jsxs)(`div`,{"data-test":`ghichu-project-tree-empty`,className:`flex flex-col p-2`,children:[(0,$.jsx)(`div`,{"data-test":`ghichu-project-tree-user`,className:`flex items-center gap-2 px-2 pb-2 border-b mb-2`,children:(0,$.jsx)(De,{variant:`ghost`,size:`sm`})}),(0,$.jsx)(`p`,{className:`px-2 text-sm text-muted-foreground`,children:`No projects yet.`})]}):(0,$.jsxs)(`div`,{"data-test":`ghichu-project-tree`,className:`h-full overflow-y-auto p-2`,children:[(0,$.jsx)(`div`,{"data-test":`ghichu-project-tree-user`,className:`flex items-center gap-2 px-2 pb-2 border-b mb-2`,children:(0,$.jsx)(De,{variant:`ghost`,size:`sm`})}),(0,$.jsx)(Ee,{data:o,onItemClick:s,onUpdate:c,onDelete:l,selectedId:i?`canvas-${i}`:null,defaultExpandedIds:a,enableEdit:!0,enableDelete:!0,enableDrag:!1,moreOptionsItems:u})]})}var cr=[{id:Ie,label:`Logs`,icon:l},{id:Le,label:`Projects`,icon:d},{id:Re,label:`Data`,icon:ne}],lr=new Set(cr.map(e=>e.id));function ur(e){return e&&lr.has(e)?e:Ie}function dr({collapsed:e,operations:t,canUndo:n,canRedo:r,onUndo:i,onRedo:o,onToggleCollapse:c,onCanvasSelected:l,onReload:u}){let[d,f]=a(),p=ur(d.get(`tab`)),m=(0,U.useCallback)(e=>{f(t=>{let n=new URLSearchParams(t);return e===`logs`?n.delete(`tab`):n.set(`tab`,e),n},{replace:!0})},[f]);return e?(0,$.jsxs)(`div`,{"data-test":`ghichu-left-panel-collapsed`,className:`flex h-full w-10 flex-col items-center border-r bg-muted/20 py-1 animate-in fade-in duration-300`,children:[(0,$.jsx)(P,{"data-test":`ghichu-left-panel-expand`,variant:`ghost`,size:`icon`,className:`h-8 w-8 mb-1`,onClick:c,title:`Expand left panel`,children:(0,$.jsx)(E,{className:`h-4 w-4`})}),cr.map(e=>{let t=e.icon,n=p===e.id;return(0,$.jsx)(P,{"data-test":`ghichu-tab-collapsed-${e.id}`,variant:`ghost`,size:`icon`,className:`h-8 w-8 ${n?`text-primary bg-primary/10`:`text-muted-foreground`}`,onClick:()=>{(0,en.flushSync)(()=>m(e.id)),c()},title:e.label,children:(0,$.jsx)(t,{className:`h-4 w-4`})},e.id)})]}):(0,$.jsxs)(`div`,{"data-test":`ghichu-left-panel`,className:`flex h-full flex-col`,children:[(0,$.jsxs)(`div`,{"data-test":`ghichu-left-panel-tabs`,className:`flex shrink-0 items-center border-b`,children:[(0,$.jsx)(P,{"data-test":`ghichu-left-panel-collapse`,variant:`ghost`,size:`icon`,className:`h-7 w-7 ml-1 shrink-0`,onClick:c,title:`Collapse left panel`,children:(0,$.jsx)(k,{className:`h-3.5 w-3.5`})}),(0,$.jsx)(`div`,{className:`flex min-w-0 flex-1 items-center overflow-x-auto`,children:cr.map(e=>{let t=e.icon;return(0,$.jsxs)(`button`,{"data-test":`ghichu-tab-${e.id}`,className:`flex shrink-0 items-center gap-1.5 px-3 py-2 text-sm font-medium transition-colors ${p===e.id?`border-b-2 border-primary text-primary`:`text-muted-foreground hover:text-foreground`}`,onClick:()=>m(e.id),children:[(0,$.jsx)(t,{className:`h-3.5 w-3.5`}),e.label]},e.id)})}),(0,$.jsxs)(`div`,{className:`flex shrink-0 items-center gap-0.5 pr-2`,children:[(0,$.jsx)(P,{"data-test":`ghichu-left-panel-undo`,variant:`ghost`,size:`icon`,className:`h-7 w-7`,disabled:!n,onClick:i,title:`Undo (Ctrl+Z)`,children:(0,$.jsx)(s,{className:`h-3.5 w-3.5`})}),(0,$.jsx)(P,{"data-test":`ghichu-left-panel-redo`,variant:`ghost`,size:`icon`,className:`h-7 w-7`,disabled:!r,onClick:o,title:`Redo (Ctrl+Shift+Z)`,children:(0,$.jsx)(g,{className:`h-3.5 w-3.5`})})]})]}),(0,$.jsxs)(`div`,{"data-test":`ghichu-left-panel-content`,className:`min-h-0 flex-1 overflow-y-auto`,children:[p===`logs`&&(0,$.jsx)(Xn,{operations:t}),p===`projects`&&(0,$.jsx)(sr,{onCanvasSelected:l}),p===`data`&&(0,$.jsx)(ar,{onReload:u})]})]})}var fr={edit:`Edit`,view:`View`},pr={focus:`Focus`,write:`Write`,highlight:`Highlight`},mr={show:`Show`,hide:`Hide`,disable:`Disable`};function hr({isOpen:e,onOpenChange:t,displayMode:n,onToggleDisplayMode:r,timestampFormat:i,onToggleTimestampFormat:a,ghichuMode:o,onToggleGhichuMode:s,editSubMode:c,onToggleEditSubMode:l,showTimestamps:u,onToggleShowTimestamps:d,showCardBorders:f,onToggleShowCardBorders:p,fontStyle:m,onToggleFontStyle:h,markdownPreview:g,onToggleMarkdownPreview:_,disableTextSelection:v,onToggleDisableTextSelection:y,lineActionsMode:b,onToggleLineActionsMode:x,onClearAllLines:S,container:C}){return(0,$.jsx)(me,{isOpen:e,onOpenChange:t,container:C,header:`Settings`,blocks:[{id:`mode`,section:`Mode`,items:[{id:`ghichu-mode`,label:`Mode`,value:fr[o],onClick:s},...o===`edit`?[{id:`edit-sub-mode`,label:`Edit Mode`,value:pr[c],onClick:l}]:[]]},{id:`text`,section:`User Interface`,title:`Text`,items:[{id:`font-style`,label:`Font`,value:m===`sans`?`Sans Serif`:`Monospace`,onClick:h},{id:`word-wrap`,label:`Word Wrap`,value:n===`wrap`?`On`:`Off`,onClick:r},{id:`markdown-preview`,label:`Markdown`,value:g?`On`:`Off`,onClick:_}]},{id:`cards`,section:`User Interface`,title:`Cards`,items:[{id:`show-card-borders`,label:`Card Borders`,value:f?`On`:`Off`,onClick:p},{id:`show-timestamps`,label:`Timestamps`,value:u?`On`:`Off`,onClick:d},...u?[{id:`timestamp-format`,label:`Timestamp Format`,value:i===`relative`?`Relative`:`Absolute`,onClick:a}]:[]]},{id:`interactions`,section:`User Interface`,title:`Interactions`,items:[{id:`line-actions-mode`,label:`Line Actions`,value:mr[b],onClick:x},{id:`disable-text-selection`,label:`Text Selection`,value:v?`Off`:`On`,onClick:y}]},{id:`debug`,section:`Debug`,items:[{id:`clear-all-lines`,label:`Clear All Messages`,onClick:S}]}]})}var gr=xe(void 0,H()??`default-user`);function _r(){let e=(0,U.useRef)(null),t=(0,U.useRef)(null),{floatingInputRef:n,editorScrollRef:r,handleFloatingSubmit:i,notes:a,activeNote:o,loadNotes:s,selectNote:c,createNote:l,renameNote:u,lines:d,groupedLines:p,operations:m,canUndo:h,canRedo:g,isLoading:_,appendContent:v,applyEdit:y,reorderLines:b,undo:S,redo:w,topicLineIds:T,focusedTopicLineId:ee,focusTopic:te,clearFocus:E,createTopic:ne,removeTopic:re,refreshState:ie,initialPinnedLineIds:D,syncPinnedLineIds:O,initialHighlightsByLineId:k,syncHighlights:A,slashMenu:j}=yn(e),{displayMode:M,timestampFormat:oe,ghichuMode:F,editSubMode:I,showTimestamps:se,showCardBorders:ce,fontStyle:L,markdownPreview:le,disableTextSelection:R,lineActionsMode:z,scrollPosition:ue,leftPanelRatio:de,leftPanelCollapsed:fe,toggleDisplayMode:me,toggleTimestampFormat:he,toggleGhichuMode:ge,toggleEditSubMode:_e,toggleShowTimestamps:ve,toggleShowCardBorders:ye,toggleFontStyle:V,toggleMarkdownPreview:be,toggleDisableTextSelection:xe,toggleLineActionsMode:H,setEditSubModeTo:Se,setScrollPosition:Ce,setLeftPanelRatio:we,toggleLeftPanelCollapsed:Te}=bn(),[Ee,De]=(0,U.useState)(()=>localStorage.getItem(ze)===`true`),W=pe(e=>e.state?.activeProjectId??null),G=pe(e=>(W?e.state?.projects[W]:null)?.activeWorkspaceId??null),K=pe(e=>{let t=W?e.state?.projects[W]:null;return(G?t?.workspaces[G]:null)?.activeCanvasId??null}),ke=pe(e=>{let t=W?e.state?.projects[W]:null;return(G?t?.workspaces[G]:null)?.canvases??null}),Ae=(0,U.useMemo)(()=>Ee?a.map(e=>({id:e.id,title:e.title})):ke?Object.values(ke).sort((e,t)=>e.createdAt-t.createdAt).map(e=>({id:e.id,title:e.name})):[],[ke,Ee,a]),je=(0,U.useRef)(!1),Me=(0,U.useRef)(de);(0,U.useEffect)(()=>{if(_||je.current)return;je.current=!0;let e=r.current;e&&requestAnimationFrame(()=>{ue===-1?e.scrollTo({top:e.scrollHeight}):e.scrollTo({top:ue})})},[_,ue,r]),(0,U.useEffect)(()=>{let e=()=>{s()};return window.addEventListener(`ghichu:reload`,e),()=>window.removeEventListener(`ghichu:reload`,e)},[s]),(0,U.useEffect)(()=>{},[r]);let Ne=(0,U.useCallback)(()=>{let e=r.current;e&&Ce(e.scrollTop)},[r,Ce]),Pe=I===`highlight`,Fe=R&&F===`edit`&&!Pe;(0,U.useEffect)(()=>{let e=r.current;if(!e||!Fe)return;let t=e=>{(e.target instanceof HTMLElement?e.target:e.target?.parentElement)?.isContentEditable||e.preventDefault()},n=()=>{let e=window.getSelection();e&&e.toString().length>0&&e.removeAllRanges()};return e.addEventListener(`selectstart`,t),e.addEventListener(`dragstart`,t),e.addEventListener(`touchend`,n),e.addEventListener(`touchcancel`,n),()=>{e.removeEventListener(`selectstart`,t),e.removeEventListener(`dragstart`,t),e.removeEventListener(`touchend`,n),e.removeEventListener(`touchcancel`,n)}},[Fe,r]);let[Ie,Le]=(0,U.useState)(!1),[Re,Be]=(0,U.useState)(!1),[Ve,He]=(0,U.useState)(null),[Ue,Ke]=(0,U.useState)(null),[qe,Je]=(0,U.useState)(null),[Xe,Ze]=(0,U.useState)(new Set),[Qe,et]=(0,U.useState)(new Map),tt=(0,U.useRef)(new Oe),[nt,rt]=(0,U.useState)(Ye);(0,U.useEffect)(()=>{et(new Map(k))},[k]),(0,U.useEffect)(()=>{D.length>0?Ze(new Set(D)):Ze(new Set)},[D]);let it=(0,U.useCallback)(e=>{Ze(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),O([...n]),n})},[O]),at=(0,U.useCallback)(e=>{let t=r.current;if(!t)return;let n=t.querySelector(`[data-line-id="${e}"]`);if(n){let r=n.offsetTop-t.offsetTop-2;t.scrollTo({top:r,behavior:`smooth`}),He(e)}},[r]),ot=(0,U.useMemo)(()=>Xe.size===0?[]:d.filter(e=>Xe.has(e.lineId)),[d,Xe]),st=(0,U.useCallback)((e,t,n)=>{let r=tt.current;et(i=>{let a=i.get(e)??[],o=r.findOverlapping(a,t,n),s;if(o.length>0){let e=new Set(o.map(e=>e.id));s=a.filter(t=>!e.has(t.id))}else{let e=r.createHighlight({start:t,end:n,color:nt});s=[...a,e]}let c=new Map(i);return s.length>0?c.set(e,s):c.delete(e),A(e,s),c})},[A,nt]),ct=(0,U.useCallback)(e=>{He(e),Ke(null),e&&T.has(e)?te(e):E()},[T,te,E]),lt=(0,U.useCallback)(e=>{Ke(e)},[]),ut=(0,U.useCallback)(()=>{Ke(null)},[]),dt=(0,U.useCallback)(e=>{ft.current=r.current?.scrollTop??0,Je(e),requestAnimationFrame(()=>{r.current?.scrollTo({top:0})})},[r]),ft=(0,U.useRef)(0),pt=(0,U.useCallback)(()=>{Je(null),requestAnimationFrame(()=>{r.current?.scrollTo({top:ft.current})})},[r]),mt=(0,U.useMemo)(()=>qe?d.find(e=>e.lineId===qe)?.text??`Details`:null,[qe,d]),ht=(0,U.useMemo)(()=>{if(!qe)return p;let e=pn(p,qe);if(e.length>0)return e;let t=p.find(e=>e.line.lineId===qe);return t?[t]:[]},[qe,p]),gt=(0,U.useCallback)((e,t)=>{y(d.map((n,r)=>r===e?t:n.text))},[d,y]),_t=(0,U.useCallback)(e=>{y(d.filter((t,n)=>n!==e).map(e=>e.text))},[d,y]),vt=(0,U.useCallback)((e,t,n)=>{b(e,t,n)},[b]),yt=(0,U.useCallback)((e,t)=>{let n=null;if((0,en.flushSync)(()=>{v(``,e,t);let r=q.noteFacade.getLines(o?.id??``)[e];r&&(n=r.lineId,He(r.lineId),Ke(r.lineId))}),n){let e=r.current?.querySelector(`[data-line-id="${n}"] [data-test="ghichu-editor-text"]`);if(e){e.contentEditable=`true`,e.focus({preventScroll:!0});let t=document.createRange();t.selectNodeContents(e),t.collapse(!1);let n=window.getSelection();n?.removeAllRanges(),n?.addRange(t)}}},[v,o,r]),bt=(0,U.useCallback)(async()=>{q.noteFacade.flushPendingSave();let e=q.repository;`deleteAllNodes`in e&&await e.deleteAllNodes(),o&&(q.textEditingService.removeLog(o.id),q.topicService.removeTopics(o.id)),He(null),Ze(new Set),E(),await s()},[o,E,s]),xt=(0,U.useCallback)((e,t,n)=>{q.setCanvasId(e),He(null),Ke(null),s()},[s]);(0,U.useEffect)(()=>q.eventBus.subscribe(e=>{e.type===`GHICHU_BDD_TAB_ACTIVATED`&&xt(We,Ge,``)}),[xt]);let St=(0,U.useCallback)(e=>{e!==K&&(B.getState().projectCanvas.switch(e),xt(e,G??``,W??``))},[K,G,W,xt]),Ct=(0,U.useCallback)(async()=>{if(!G||!W)return;let e=await gr.canvases.create(G,`New Canvas`),t=B.getState();t.project.switch(W),t.workspace.switch(G),t.projectCanvas.create(e.name,e.id),xt(e.id,G,W)},[G,W,xt]),wt=(0,U.useCallback)(async(e,t)=>{await gr.canvases.update(e,t),B.getState().projectCanvas.updateMetadata(e,{name:t})},[]),Tt=N();return(0,$.jsxs)(`div`,{"data-test":`ghichu-page`,ref:e,tabIndex:-1,className:`relative flex h-full w-full overflow-hidden outline-none ${$e[L]}`,children:[(0,$.jsx)(`div`,{className:`hidden overflow-hidden border-r md:block transition-[width] duration-200 ease-in-out ${fe?`w-10`:``}`,style:fe?void 0:{width:`${de*100}%`},children:(0,$.jsx)(dr,{collapsed:fe,operations:m,canUndo:h,canRedo:g,onUndo:S,onRedo:w,onToggleCollapse:Te,onCanvasSelected:xt,onReload:()=>{De(localStorage.getItem(ze)===`true`),s()}})}),!fe&&(0,$.jsx)(`div`,{"data-test":`ghichu-resize-handle`,className:`hidden md:flex w-1.5 shrink-0 cursor-col-resize items-center justify-center hover:bg-primary/10 active:bg-primary/20 transition-colors`,onMouseDown:t=>{t.preventDefault();let n=t.clientX,r=Me.current,i=e.current;if(!i)return;let a=i.offsetWidth,o=e=>{let t=e.clientX-n,o=Math.min(.8,Math.max(.15,r+t/a));Me.current=o;let s=i.querySelector(`[data-test='ghichu-left-panel'], [data-test='ghichu-left-panel-collapsed']`)?.parentElement;s&&(s.style.width=`${o*100}%`)},s=()=>{document.removeEventListener(`mousemove`,o),document.removeEventListener(`mouseup`,s),we(Me.current)};document.addEventListener(`mousemove`,o),document.addEventListener(`mouseup`,s)},onTouchStart:t=>{let n=t.touches[0];if(!n)return;let r=n.clientX,i=Me.current,a=e.current;if(!a)return;let o=a.offsetWidth,s=e=>{let t=e.touches[0];if(!t)return;let n=t.clientX-r,s=Math.min(.8,Math.max(.15,i+n/o));Me.current=s;let c=a.querySelector(`[data-test='ghichu-left-panel'], [data-test='ghichu-left-panel-collapsed']`)?.parentElement;c&&(c.style.width=`${s*100}%`)},c=()=>{document.removeEventListener(`touchmove`,s),document.removeEventListener(`touchend`,c),document.removeEventListener(`touchcancel`,c),we(Me.current)};document.addEventListener(`touchmove`,s),document.addEventListener(`touchend`,c),document.addEventListener(`touchcancel`,c)},children:(0,$.jsx)(`div`,{className:`w-px h-8 bg-border rounded-full`})}),Tt&&(0,$.jsx)(`div`,{"data-test":`ghichu-mobile-sidebar`,className:`absolute inset-0 w-full max-w-[100vw] overflow-hidden bg-background transition-transform duration-300 ease-in-out`,style:{transform:Re?`translateX(0)`:`translateX(-100%)`},children:(0,$.jsx)(dr,{collapsed:!1,operations:m,canUndo:h,canRedo:g,onUndo:S,onRedo:w,onToggleCollapse:()=>Be(!1),onCanvasSelected:(e,t,n)=>{xt(e,t,n),Be(!1)},onReload:()=>{De(localStorage.getItem(`ghichu_local_mode`)===`true`),s()}})}),(0,$.jsxs)(`div`,{"data-test":`ghichu-right-panel`,ref:t,className:`relative flex flex-1 flex-col overflow-hidden transition-transform duration-300 ease-in-out md:!translate-x-0`,style:{transform:Tt&&Re?`translateX(100%)`:`translateX(0)`},children:[(0,$.jsxs)(`div`,{"data-test":`ghichu-tabbar-row`,className:`flex shrink-0 items-center`,children:[(0,$.jsx)(P,{"data-test":`ghichu-mobile-sidebar-trigger`,variant:`ghost`,size:`icon`,className:`h-8 w-8 shrink-0 md:hidden`,onClick:()=>Be(!0),children:(0,$.jsx)(f,{className:`h-4 w-4`})}),(0,$.jsx)(`div`,{className:`min-w-0 flex-1`,children:(0,$.jsx)(Un,{notes:Ae,activeNoteId:K,onSelectNote:St,onCreateNote:()=>void Ct(),onRenameNote:(e,t)=>void wt(e,t)})})]}),qe&&mt&&(0,$.jsxs)(`div`,{"data-test":`ghichu-topic-breadcrumb`,className:`flex shrink-0 items-center gap-2 border-b bg-muted/30 px-4 py-2`,children:[(0,$.jsx)(P,{"data-test":`ghichu-topic-breadcrumb-back`,variant:`ghost`,size:`icon`,className:`h-6 w-6`,onClick:pt,children:(0,$.jsx)(ae,{className:`h-4 w-4`})}),(0,$.jsx)(`span`,{"data-test":`ghichu-topic-breadcrumb-title`,className:`text-sm font-medium truncate`,children:mt}),(0,$.jsxs)(P,{"data-test":`ghichu-topic-breadcrumb-exit`,variant:`ghost`,size:`sm`,className:`ml-auto h-6 px-2 text-xs text-muted-foreground`,onClick:pt,children:[(0,$.jsx)(C,{className:`mr-1 h-3 w-3`}),`Exit`]})]}),ot.length>0&&(0,$.jsxs)(`div`,{"data-test":`ghichu-pinned-banner`,className:`flex shrink-0 items-center gap-1.5 border-b px-4 py-1`,children:[(0,$.jsx)(x,{className:`h-3 w-3 shrink-0 text-muted-foreground/50`}),(0,$.jsx)(`div`,{"data-test":`ghichu-pinned-banner-items`,className:`flex min-w-0 flex-1 items-center gap-1 overflow-x-auto`,children:ot.map(e=>(0,$.jsx)(`button`,{"data-test":`ghichu-pinned-banner-item`,onClick:()=>at(e.lineId),className:`shrink-0 truncate rounded px-1.5 py-0.5 text-xs text-muted-foreground hover:text-foreground hover:bg-muted active:bg-muted/70 transition-colors max-w-[200px]`,children:e.text||`Empty line`},e.lineId))})]}),(0,$.jsx)(`div`,{"data-test":`ghichu-editor-scroll`,ref:r,onScroll:Ne,className:`flex-1 overflow-y-auto p-4 pb-20 ${Fe?`select-none`:`select-text`}`,style:Fe?{WebkitTouchCallout:`none`,WebkitUserSelect:`none`}:void 0,children:!_&&(0,$.jsx)(Nn,{groupedLines:ht,topicLineIds:T,highlightedLineId:Ve,editingLineId:Ue,isFocused:!!qe,showTimestamps:se,showCardBorders:ce,fontStyle:L,markdownPreview:le,timestampFormat:oe,ghichuMode:F,onLineEdit:gt,onDeleteLine:_t,onMoveLine:vt,onCreateTopic:(e,t,n)=>{ne(e,t,n),te(e)},onRemoveTopic:re,onFocusTopic:dt,onHighlightLine:ct,onInsertLine:yt,onStartEditing:lt,onStopEditing:ut,pinnedLineIds:Xe,onTogglePin:it,editSubMode:I,lineActionsMode:z,highlightsByLineId:Qe,onToggleTextHighlight:st,onToggleHighlightMode:()=>Se(Pe?`focus`:`highlight`),highlightColor:nt,onSetHighlightColor:rt,onExtractHighlights:e=>{let t=Qe.get(e);if(!t||t.length===0)return;let n=d.find(t=>t.lineId===e);if(!n)return;T.has(e)||ne(e,n.text);let r=[...t].sort((e,t)=>e.start-t.start).map(e=>n.text.slice(e.start,e.end).trim()).filter(Boolean).join(` `),i=p.findIndex(t=>t.line.lineId===e);i<0||!r||v(r,i+1,e)},onClearLineHighlights:e=>{et(t=>{let n=new Map(t);return n.delete(e),A(e,[]),n})}})}),(0,$.jsx)(Gn,{ref:n,onSubmit:i,onSettingsOpen:()=>Le(!0),onKeyDown:j.handleKeyDown,onInputChange:j.handleChange,slashMenu:{isOpen:j.isOpen,filteredCommands:j.filteredCommands,selectedIndex:j.selectedIndex,menuPosition:j.menuPosition,selectCommand:j.selectCommand,close:j.close}}),(0,$.jsx)(hr,{isOpen:Ie,onOpenChange:Le,displayMode:M,onToggleDisplayMode:me,timestampFormat:oe,onToggleTimestampFormat:he,ghichuMode:F,onToggleGhichuMode:ge,editSubMode:I,onToggleEditSubMode:_e,showTimestamps:se,onToggleShowTimestamps:ve,showCardBorders:ce,onToggleShowCardBorders:ye,fontStyle:L,onToggleFontStyle:V,markdownPreview:le,onToggleMarkdownPreview:be,disableTextSelection:R,onToggleDisableTextSelection:xe,lineActionsMode:z,onToggleLineActionsMode:H,onClearAllLines:bt,container:t.current})]})]})}function vr(){return(0,$.jsx)(_e,{app:$t,onTabChange:(0,U.useCallback)(e=>{e===`bdd`&&q.eventBus.emit({type:`GHICHU_BDD_TAB_ACTIVATED`,timestamp:Date.now()})},[]),children:(0,$.jsx)(_r,{})})}export{vr as GhichuAppShell};