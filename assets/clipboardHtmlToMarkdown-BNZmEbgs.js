...
`).trim()}function v(e,t={}){const r={...L,...t},c=document.createElement("div");c.innerHTML=e;const s=i(c,r);return x(s)}function k(e){return e.includes("docs-internal-guid")||e.includes('id="docs-internal-guid')}export{v as h,k as i};
